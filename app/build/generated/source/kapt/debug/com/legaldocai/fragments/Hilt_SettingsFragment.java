...
public abstract class Hilt_SettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SettingsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingsFragment_GeneratedInjector) this.generatedComponent()).injectSettingsFragment(UnsafeCasts.<SettingsFragment>unsafeCast(this));
    }
  }
