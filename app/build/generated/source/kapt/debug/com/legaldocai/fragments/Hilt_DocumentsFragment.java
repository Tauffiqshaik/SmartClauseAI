...
public abstract class Hilt_DocumentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DocumentsFragment() {
    super();
  }

  Hilt_DocumentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DocumentsFragment_GeneratedInjector) this.generatedComponent()).injectDocumentsFragment(UnsafeCasts.<DocumentsFragment>unsafeCast(this));
    }
  }
